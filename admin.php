        ...
        <!--div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer">
            <div class="mdl-layout__drawer sidenav">
                ...
                <nav class="mdl-navigation">
                    <a class="mdl-navigation__link" href="#!/messentry">Mess Card Entry</a>
                    <a class="mdl-navigation__link" href="#!/extrasentry">Extras Entry</a>
                    <a class="mdl-navigation__link" href="#!/messcuts">Mess Cuts</a>
                    <a class="mdl-navigation__link" href="#!/billings">Billings</a>
                    <a class="mdl-navigation__link" href="#!/messinfo">Mess Info</a>
